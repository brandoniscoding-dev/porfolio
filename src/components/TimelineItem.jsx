...
import ConfettiExplosion from "react-confetti-explosion"; // Utilisation optionnelle pour effet confetti
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileHover={{ scale: 1.3, boxShadow: `0px 0px 12px ${experience.color}` }}
        style={{ borderColor: experience.color }}
      >
        <experience.Icon className="text-lg" style={{ color: experience.color }} />
        {isHovered && (
          <ConfettiExplosion force={0.4} duration={1200} particleCount={20} width={160} />
        )}
      </motion.div>

      {/* Contenu avec tags techs */}
      <motion.div
      ...
      >
        ...
        <span className="text-stone-400 text-sm">{experience.year}</span>
